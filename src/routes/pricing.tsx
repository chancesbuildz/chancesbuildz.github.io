...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "Pricing — Chance's Studios" },
      {
        name: "description",
        content:
          "Pricing for Roblox models, weapons, VFX and full maps by Chance's Studios.",
      },
      { property: "og:title", content: "Pricing — Chance's Studios" },
      {
